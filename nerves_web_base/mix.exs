defmodule NervesWebBase.MixProject do
  use Mix.Project
  ...
  # invoke NervesWebBase.start/2 when running on a target.
  def application("host") do
    [extra_applications: [:logger]]
  end

  def application(_target) do
    [mod: {NervesWebBase.Application, []}, extra_applications: [:logger, :ui, :nerves_ntp]]
  end
